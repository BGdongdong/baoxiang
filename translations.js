const translations = {
    ...
    en: {
        ...
        "advantage-1-title": "Advanced Manufacturing Processes",
        "advantage-1-desc": "Adopting internationally leading stamping and welding technologies to ensure product precision and consistency",
        ...
        "product-2-desc": "Chassis suspension system components, precision stamping process to ensure driving stability",
        "product-3-title": "Welding Assembly Parts",
        "product-3-desc": "Laser welding assembly components, high-precision welding process to ensure structural strength and durability",
        ...
        "product-5-desc": "Recycling and reuse of waste metal materials, environmentally friendly processes to reduce production costs",
        "product-6-title": "Waste Parts Recycling",
        "product-6-desc": "Disassembly and recycling of waste auto parts, professional processing and resource reuse",
        
        // 技术服务
        "services-tag": "Technical Services",
        "services-title": "Professional Technical Support and Services",
        "services-desc": "From product design to production and manufacturing, we provide comprehensive technical support and solutions",
        "process-1-title": "Stamping Process",
        "process-1-desc": "Adopting advanced stamping equipment and processes to complete high-precision stamping forming of complex-shaped parts. With 200-1600 ton stamping production lines of different specifications, achieving full-range processing capabilities from thin plates to thick plates.",
        "process-2-title": "Welding Process",
        "process-2-desc": "Integrating a variety of advanced welding technologies, including spot welding, arc welding, laser welding, etc., to ensure welding quality and efficiency. Automated welding production lines improve production efficiency and product consistency.",
        "equipment-tag": "Equipment Display",
        "equipment-title": "Advanced Equipment, Excellent Manufacturing",
        "equipment-1-title": "Precision Stamping Equipment",
        "equipment-1-desc": "Japan Komatsu 1600-ton fully automatic stamping production line, high precision, high efficiency",
        ...
        "equipment-3-desc": "Germany Zeiss coordinate measuring machine, 3D dimensional accuracy inspection",
        ...
        "quality-1-desc": "All raw materials are strictly inspected before entering the factory to ensure the material meets the standard requirements and control product quality from the source.",
        "quality-2-title": "Process Control",
        "quality-2-desc": "Implement comprehensive quality control in the production process, set quality control points for key processes, and monitor production parameters in real time.",
        "quality-3-title": "Finished Product Inspection",
        "quality-3-desc": "100% full inspection before delivery, including dimensional inspection, appearance inspection, performance testing, etc., to ensure product qualification.",
        ...
        "news-2-title": "Analysis of Development Trends in the Auto Parts Industry",
        "news-2-desc": "With the rapid development of new energy vehicles, the auto parts industry is facing new opportunities and challenges, with lightweight and intelligence becoming the development direction.",
        "news-3-cat": "Technological Innovation",
        "news-3-title": "New High-Strength Steel Stamping Technology Successfully Developed",
        "news-3-desc": "The new high-strength steel stamping technology developed by our company has obtained national patents, which can effectively improve part strength and reduce body weight.",
        ...
        // 导航链接
        "nav-links": ["Home", "About Us", "Products", "Technical Services", "Quality Assurance", "News", "Contact Us"],
